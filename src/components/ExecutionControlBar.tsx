    ...
    <AnimatePresence>
      {isExecuting && (
        ...
        >
          ...
          {/* Status text */}
          <span className="text-sm font-medium">{t('execution_control.executing')}</span>
          ...
          <div className="flex items-center gap-4 text-xs text-muted-foreground">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span>{formatTokens(totalTokens)} {t('execution_control.tokens')}</span>
            </div>
          </div>
