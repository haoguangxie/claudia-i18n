        ...
        <div className="flex items-center space-x-2 text-xs">
          ...
          <span>
            {versionStatus.is_installed && versionStatus.version
              ? t('topbar.claude_code_version', { version: versionStatus.version })
              : t('topbar.claude_code')}
          </span>
        </div>
      </Button>
    );
        ...
        <Popover
          ...
          content={
            <div className="space-y-3 max-w-xs">
              <p className="text-sm font-medium">{t('topbar.not_found')}</p>
              ...
              >
                <span>{t('topbar.install_claude')}</span>
